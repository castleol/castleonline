...
if math.random(100)<=(50+GetLuck()) and GetTaskBit("魔魂","BOSS",1)==0 and GetMultiplayer()>0 then
x=x+32
AddDropItem("一阶魔魂",x,y,1,"魔魂","BOSS")
do return end
end

if math.random(100)<=(50+GetLuck()) and GetTaskBit("掉落物品","幸运宝石",1)==0 then
x=x+32
AddDropItem("幸运宝石",x,y,1,"掉落物品","幸运宝石")
do return end
end
